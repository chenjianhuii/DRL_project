...
from my_minigrid import minigrid_env, wrappers
from my_minigrid.core import roomgrid
from my_minigrid.core.world_object import Wall
...
try:
    ...
    if "my_minigrid" in notifications and __version__ in notifications["my_minigrid"]:
        print(notifications["my_minigrid"][__version__], file=sys.stderr)
...
def register_minigrid_envs():
    ...
    register(
        id="BabyAI-GoToLocalS16N14-v0",
        entry_point="minigrid.envs.babyai:GoToLocal",
        kwargs={"room_size": 16, "num_dists": 14},
    )
...
register(
    id="BabyAI-GoToRedBallGrey-v1",
    entry_point="my_minigrid.envs.babyai:GoToRedBallGrey",
    kwargs={"room_size": 15, "num_dists": 10, "max_steps": 100},
)

register(
    id="BabyAI-MyGoToRedBallGrey-v1",
    entry_point="my_minigrid.envs.babyai:MyGoToRedBallGrey",
    kwargs={"room_size": 15, "num_dists": 10, "max_steps": 100},
)
register(
    id="BabyAI-GoToRedBallGrey-v2",
    entry_point="my_minigrid.envs.babyai:GoToRedBallGrey",
    kwargs={"room_size": 20, "num_dists": 50},
)

register(
    id="BabyAI-GoToRedBallGrey-v3",
    entry_point="my_minigrid.envs.babyai:GoToRedBallGrey",
    kwargs={"room_size": 25, "num_dists": 50},
)

register(
    id="BabyAI-PickupLoc-v2",
    entry_point="my_minigrid.envs.babyai:PickupLoc",
    kwargs={"room_size": 9, "num_dists": 5, "max_steps": 200},
)

register(
    id="BabyAI-PickupLoc-v3",
    entry_point="my_minigrid.envs.babyai:MyPickupLoc",
    kwargs={"room_size": 9, "num_dists": 5, "max_steps": 200},
)
